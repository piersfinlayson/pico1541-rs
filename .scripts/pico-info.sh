...
usbcmd/usbcmd.py -v 0x1209 -p 0xf541 control in -t 0xa1 -r 0x06 -v 0 -i 0 -l 8

# -r 0x07 is the request ID for GCC version
usbcmd/usbcmd.py -v 0x1209 -p 0xf541 control in -t 0xa1 -r 0x07 -v 0 -i 0 -l 8

# -r 0x08 is the request ID for Pico SDK version
usbcmd/usbcmd.py -v 0x1209 -p 0xf541 control in -t 0xa1 -r 0x08 -v 0 -i 0 -l 8
